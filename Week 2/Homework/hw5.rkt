...
(define (racketlist->mupllist rkt-lst)
  (if (null? rkt-lst)
      (aunit)
      (apair (car rkt-lst) (racketlist->mupllist (cdr rkt-lst)))))

(define (mupllist->racketlist mupl-lst)
  (if (aunit? mupl-lst)
      null
      (cons (apair-e1 mupl-lst) (mupllist->racketlist (apair-e2 mupl-lst)))))
...
(define (ifeq e1 e2 e3 e4)
    (mlet* (list (cons "val_1" e1)(cons "val_2" e2))
       (ifgreater (var "val_1") (var "val_2") e4
                  (ifgreater (var "val_2") (var "val_1") e4 e3))))
...
(define mupl-mapAddN
  (fun #f "my-int"
       (fun "map-rec" "lst"
            (mlet "map" mupl-map
                  (call (call (var "map") (fun #f "elem" (add (var "my-int") (var "elem")))) (var "lst"))))))
